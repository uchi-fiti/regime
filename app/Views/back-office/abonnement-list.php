<section class="login-section">
  <div class="container">
    <div class="section-title">
      ...
      <h1 class="h2">Liste des abonnements</h1>
      <p class="section-sub">Gérez les plans d'abonnement disponibles.</p>
    </div>
          ...
          <tbody>
            <?php foreach ($abonnements as $abo): ?>
              <tr style="border-bottom: 1px solid var(--border);">
                <td style="padding: 1rem;"><?= $abo['id'] ?></td>
                <td style="padding: 1rem; font-weight: 500;"><?= $abo['label'] ?></td>
