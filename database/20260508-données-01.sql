...
INSERT INTO regime (label, pourcentage_viande, pourcentage_poisson, pourcentage_volaille, variation_poids_journalier, prix_journalier) VALUES 
('Hyper-Protéiné', 60.0, 20.0, 20.0, 0.200, 15000), 
('Équilibre Marin', 10.0, 70.0, 20.0, -0.150, 12000),
('Végétarien (Mix)', 0.0, 0.0, 0.0, -0.100, 8000),
('Carnivore Bulk', 80.0, 10.0, 10.0, 0.300, 20000),
('Léger Fitness', 20.0, 40.0, 40.0, -0.050, 10000);
